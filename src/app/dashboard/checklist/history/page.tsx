...
export default function ChecklistHistoryPage() {
  ...
  useEffect(() => {
   ...
   }, [checklists, dateFilter, categoryFilter, statusFilter, workerFilter, searchTerm]);
  ...
  const handleSingleDownload = (checklist: ChecklistRecord) => {
    exportSingleChecklist(checklist);
  };
  ...
  const handleMultipleDownload = () => {
    ...
    exportMultipleChecklists(selectedChecklistData);
